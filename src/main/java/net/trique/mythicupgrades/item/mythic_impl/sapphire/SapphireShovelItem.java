...
import net.trique.mythicupgrades.item.mythic_impl.common.MythicEffectsShovelItem;
...
public class SapphireShovelItem extends MythicEffectsShovelItem implements VirtualSapphireTool {
    ...
    public SapphireShovelItem(float percent, Properties settings, ItemEffectsList effects, String tooltipKey, ChatFormatting color) {
