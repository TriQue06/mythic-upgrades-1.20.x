...
import net.trique.mythicupgrades.item.mythic_impl.common.MythicEffectsHoeItem;
...
public class SapphireHoeItem extends MythicEffectsHoeItem implements VirtualSapphireTool {
    ...
    public SapphireHoeItem(float percent, Properties settings, ItemEffectsList effects, String tooltipKey, ChatFormatting color) {
