...
public class SapphireHoeItem extends MythicEffectsHoeItem {
    private int percent;

    public SapphireHoeItem(int attackDamage, int percent, float attackSpeed, Settings settings, ItemEffectsList effects, String tooltipKey, Formatting color) {
