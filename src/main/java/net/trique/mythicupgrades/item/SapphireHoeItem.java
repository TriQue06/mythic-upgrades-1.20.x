...
public class SapphireHoeItem extends MythicEffectsHoeItem implements VirtualSapphireTool {
    ...
    public SapphireHoeItem(int attackDamage, float percent, float attackSpeed, Properties settings, ItemEffectsList effects, String tooltipKey, ChatFormatting color) {
