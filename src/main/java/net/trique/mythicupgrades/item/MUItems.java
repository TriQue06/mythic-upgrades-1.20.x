...
public class MUItems {
    ...
    public static final MythicEffectsAxeItem PERIDOT_AXE = new MythicEffectsAxeItem(MUToolMaterials.PERIDOT, 5, -3f, (new FabricItemSettings().fireResistant()), poisonToolEffects, "peridot_axe.description", ChatFormatting.GREEN);
    public static final MythicEffectsSwordItem PERIDOT_SWORD = new MythicEffectsSwordItem(MUToolMaterials.PERIDOT, 3, -2.4f, (new FabricItemSettings().fireResistant()), poisonToolEffects, "peridot_sword.description", ChatFormatting.GREEN);
    ...
    public static final MythicEffectsShovelItem RUBY_SHOVEL = new MythicEffectsShovelItem(MUToolMaterials.RUBY, 2, -3.0f, (new FabricItemSettings().fireResistant()), hasteToolEffects, "ruby_shovel.description", ChatFormatting.RED);
    public static final MythicEffectsPickaxeItem RUBY_PICKAXE = new MythicEffectsPickaxeItem(MUToolMaterials.RUBY, 1, -2.8f, (new FabricItemSettings().fireResistant()), hasteToolEffects, "ruby_pickaxe.description", ChatFormatting.RED);
    public static final MythicEffectsAxeItem RUBY_AXE = new MythicEffectsAxeItem(MUToolMaterials.RUBY, 5, -3f, (new FabricItemSettings().fireResistant()), hasteToolEffects, "ruby_axe.description", ChatFormatting.RED);
    public static final MythicEffectsHoeItem RUBY_HOE = new MythicEffectsHoeItem(MUToolMaterials.RUBY, -4, 0.0f, (new FabricItemSettings().fireResistant()), hasteToolEffects, "ruby_hoe.description", ChatFormatting.RED);
    ...
    public static final SapphireAxeItem SAPPHIRE_AXE = new SapphireAxeItem(5, CONFIG.sapphireConfig.tools_percentage_damage_percent(), -3.0f, (new FabricItemSettings().fireResistant()), new ItemEffectsList(), "sapphire_axe.description", ChatFormatting.DARK_BLUE);
    public static final SapphireSwordItem SAPPHIRE_SWORD = new SapphireSwordItem(3, CONFIG.sapphireConfig.tools_percentage_damage_percent(), -2.4f, (new FabricItemSettings().fireResistant()), new ItemEffectsList(), "sapphire_sword.description", ChatFormatting.DARK_BLUE);
    ...
    public static final Item TOPAZ_SHOVEL = new MythicEffectsShovelItem(MUToolMaterials.TOPAZ, 2, -3.0f, (new FabricItemSettings().fireResistant()), noToolEffects, "topaz_shovel.description", ChatFormatting.GOLD);
    public static final Item TOPAZ_PICKAXE = new MythicEffectsPickaxeItem(MUToolMaterials.TOPAZ, 1, -2.8f, (new FabricItemSettings().fireResistant()), noToolEffects, "topaz_pickaxe.description", ChatFormatting.GOLD);
    public static final Item TOPAZ_AXE = new MythicEffectsAxeItem(MUToolMaterials.TOPAZ, 5, -3f, (new FabricItemSettings().fireResistant()), noToolEffects, "topaz_axe.description", ChatFormatting.GOLD);
    public static final Item TOPAZ_HOE = new MythicEffectsHoeItem(MUToolMaterials.TOPAZ, -4, 0.0f, (new FabricItemSettings().fireResistant()), noToolEffects, "topaz_hoe.description", ChatFormatting.GOLD);
    public static final Item TOPAZ_SWORD = new MythicEffectsSwordItem(MUToolMaterials.TOPAZ, 3, -2.4f, (new FabricItemSettings().fireResistant()), noToolEffects, "topaz_sword.description", ChatFormatting.GOLD);
    ...
    public static final MythicEffectsAxeItem AMETRINE_AXE = new MythicEffectsAxeItem(MUToolMaterials.AMETRINE, 5, -3.0f, (new FabricItemSettings().fireResistant()), levitationToolEffects, "ametrine_axe.description", ChatFormatting.DARK_PURPLE);
    public static final MythicEffectsSwordItem AMETRINE_SWORD = new MythicEffectsSwordItem(MUToolMaterials.AMETRINE, 3, -2.4f, (new FabricItemSettings().fireResistant()), levitationToolEffects, "ametrine_sword.description", ChatFormatting.DARK_PURPLE);
    ...
    public static final MythicEffectsAxeItem JADE_AXE = new MythicEffectsAxeItem(MUToolMaterials.JADE, 5, -2.4f, (new FabricItemSettings().fireResistant()), noToolEffects, "jade_axe.description", ChatFormatting.DARK_GREEN);
    public static final MythicEffectsSwordItem JADE_SWORD = new MythicEffectsSwordItem(MUToolMaterials.JADE, 3, -1.8f, (new FabricItemSettings().fireResistant()), noToolEffects, "jade_sword.description", ChatFormatting.DARK_GREEN);
