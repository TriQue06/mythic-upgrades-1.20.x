...
public class MUItems {
    ...
    public static final Item TOPAZ_SWORD = new TopazSwordItem(new FabricItemSettings().fireResistant(), 3, -2.4f, noToolEffects, "topaz_tool.description", ChatFormatting.GOLD);
