...
public class ThornsArmorItem extends ArmorItem {
    ...
    private void evaluateArmorEffects(PlayerEntity player) {
        for (Map.Entry<ArmorMaterial, StatusEffectInstance> entry : MATERIAL_TO_EFFECT_MAP.entrySet()) {
            ArmorMaterial mapArmorMaterial = MythicArmorMaterials.SAPPHIRE;
            StatusEffectInstance mapStatusEffect = new StatusEffectInstance(MythicEffects.THORNS,
    ...
    private void addStatusEffectForMaterial(PlayerEntity player, ArmorMaterial mapArmorMaterial, StatusEffectInstance mapStatusEffect) {
        ...
        if(hasCorrectArmorOn(mapArmorMaterial, player) && !hasPlayerEffect) {
            player.addStatusEffect(new StatusEffectInstance(MythicEffects.THORNS,
                    effectDuration, amplifier, false, false, false));
        }

        // effect repeat issue fix
        if (player.getActiveStatusEffects().containsKey(MythicEffects.THORNS)) {
