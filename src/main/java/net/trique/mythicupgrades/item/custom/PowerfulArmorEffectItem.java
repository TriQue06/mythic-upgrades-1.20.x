...
public class PowerfulArmorEffectItem extends ArmorItem {
    private static final int effectDuration = 400;
    private static final int amplifier = 1;
    private final StatusEffect effect;

    public PowerfulArmorEffectItem(ArmorMaterial material, Type type, Settings settings, StatusEffect effect) {
