...
public class SapphirePickaxeItem extends MythicEffectsPickaxeItem implements VirtualSapphireTool {
    ...
    public SapphirePickaxeItem(int attackDamage, int percent, float attackSpeed, Properties settings, ItemEffectsList effects, String tooltipKey, ChatFormatting color) {
