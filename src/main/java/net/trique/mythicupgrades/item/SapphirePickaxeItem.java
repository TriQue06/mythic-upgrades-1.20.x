...
public class SapphirePickaxeItem extends MythicEffectsPickaxeItem implements VirtualSapphireTool {
    ...
    public SapphirePickaxeItem(int attackDamage, float percent, float attackSpeed, Properties settings, ItemEffectsList effects, String tooltipKey, ChatFormatting color) {
