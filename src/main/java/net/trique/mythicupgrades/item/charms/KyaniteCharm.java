...
public class KyaniteCharm extends TrinketItem {
    ...
    public Multimap<EntityAttribute, EntityAttributeModifier> getModifiers(ItemStack stack, SlotReference slot, LivingEntity entity, UUID uuid) {
        ...
        modifiers.put(MUAttributes.LAVA_SPEED, new EntityAttributeModifier(uuid, "mythicupgrades:lava_speed", 0.6, EntityAttributeModifier.Operation.MULTIPLY_TOTAL));
        modifiers.put(MUAttributes.LAVA_VISIBILITY, new EntityAttributeModifier(uuid, "mythicupgrades:lava_visibility", 60, EntityAttributeModifier.Operation.ADDITION));
        return modifiers;
    }
}