...
public class HitAndGetHoeItem extends HoeItem implements BaseMythicToolItem {
    ...
    public HitAndGetHoeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings,
