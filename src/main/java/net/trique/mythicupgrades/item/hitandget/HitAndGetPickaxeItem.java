...
public class HitAndGetPickaxeItem extends PickaxeItem implements BaseMythicToolItem {
    ...
    public HitAndGetPickaxeItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings,
