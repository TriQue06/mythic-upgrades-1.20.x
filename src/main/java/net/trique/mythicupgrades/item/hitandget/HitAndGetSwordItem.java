...
public class HitAndGetSwordItem extends SwordItem implements BaseMythicToolItem {
    ...
    public HitAndGetSwordItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings,
