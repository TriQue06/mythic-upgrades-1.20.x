...
public class HitAndGetShovelItem extends ShovelItem implements BaseMythicToolItem {
    ...
    public HitAndGetShovelItem(ToolMaterial material, int attackDamage, float attackSpeed, Settings settings,
