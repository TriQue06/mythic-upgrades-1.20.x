...
public class MUFoods {public static final FoodComponent JADE_POTION = (new FoodComponent.Builder()).hunger(4).saturationModifier(0.4F).
        statusEffect(new StatusEffectInstance(MUEffects.POISONOUS_THORNS, 3600, 0), 1.0F).
            statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 3600, 0), 0.5F).
        alwaysEdible().build();
    ...
    public static final FoodComponent TOPAZ_POTION = (new FoodComponent.Builder()).hunger(4).saturationModifier(0.4F).
        statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 3600, 0), 1.0F)
                ...
                .statusEffect(new StatusEffectInstance(StatusEffects.RESISTANCE, 3600, 0), 0.5F).
        alwaysEdible().build();
    ...
    public static final FoodComponent AQUAMARINE_POTION = (new FoodComponent.Builder()).hunger(4).saturationModifier(0.4F).
            ...
            statusEffect(new StatusEffectInstance(StatusEffects.CONDUIT_POWER, 3600, 0), 0.5F).
        alwaysEdible().build();
    ...
    public static final FoodComponent KYANITE_POTION = (new FoodComponent.Builder()).hunger(4).saturationModifier(0.4F).
        statusEffect(new StatusEffectInstance(MUEffects.ICE_SHIELD, 3600, 2), 1.0F).
        statusEffect(new StatusEffectInstance(StatusEffects.INSTANT_HEALTH, 20, 0), 0.5F).
        alwaysEdible().build();
    ...
    public static final FoodComponent AMETRINE_POTION = (new FoodComponent.Builder()).hunger(4).saturationModifier(0.4F).
        statusEffect(new StatusEffectInstance(StatusEffects.SPEED, 3600, 2), 1.0F).
            ...
            statusEffect(new StatusEffectInstance(StatusEffects.SLOW_FALLING, 600, 0), 0.5F).
        alwaysEdible().build();
}