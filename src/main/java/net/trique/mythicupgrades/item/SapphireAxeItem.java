...
public class SapphireAxeItem extends MythicEffectsAxeItem implements VirtualSapphireTool {
    ...
    public SapphireAxeItem(int attackDamage, float percent,float attackSpeed, Properties settings, ItemEffectsList effects, String tooltipKey, ChatFormatting color) {
