    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, AQUAMARINE_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        List.of(MUBlocks.AQUAMARINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.AQUAMARINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.AQUAMARINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.AQUAMARINE_CRYSTAL_CLUSTER.getDefaultState()),
        ...
        register(context, CITRINE_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        BlockStateProvider.of(Blocks.CALCITE),
                        BlockStateProvider.of(Blocks.SMOOTH_BASALT),
                        List.of(MUBlocks.CITRINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.CITRINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.CITRINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.CITRINE_CRYSTAL_CLUSTER.getDefaultState()),
                        BlockTags.FEATURES_CANNOT_REPLACE , BlockTags.GEODE_INVALID_BLOCKS),
                        new GeodeLayerThicknessConfig(1.7, 2.2, 3.2, 4.2),
                        new GeodeCrackConfig(0.95, 2.0, 2),
                        0.35, 0.083,
        ...
        register(context, PERIDOT_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        BlockStateProvider.of(Blocks.CALCITE),
                        BlockStateProvider.of(Blocks.SMOOTH_BASALT),
                        List.of(MUBlocks.PERIDOT_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.PERIDOT_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.PERIDOT_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.PERIDOT_CRYSTAL_CLUSTER.getDefaultState()),
                        BlockTags.FEATURES_CANNOT_REPLACE , BlockTags.GEODE_INVALID_BLOCKS),
                        new GeodeLayerThicknessConfig(1.7, 2.2, 3.2, 4.2),
                        new GeodeCrackConfig(0.95, 2.0, 2),
                        0.35, 0.083,
        ...
        register(context, ZIRCON_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        BlockStateProvider.of(Blocks.CALCITE),
                        BlockStateProvider.of(Blocks.SMOOTH_BASALT),
                        List.of(MUBlocks.ZIRCON_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.ZIRCON_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.ZIRCON_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.ZIRCON_CRYSTAL_CLUSTER.getDefaultState()),
                        BlockTags.FEATURES_CANNOT_REPLACE , BlockTags.GEODE_INVALID_BLOCKS),
                        new GeodeLayerThicknessConfig(1.7, 2.2, 3.2, 4.2),
                        new GeodeCrackConfig(0.95, 2.0, 2),
                        0.35, 0.083,
        ...
        register(context, RUBY_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        BlockStateProvider.of(Blocks.CALCITE),
                        BlockStateProvider.of(Blocks.SMOOTH_BASALT),
                        List.of(MUBlocks.RUBY_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.RUBY_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.RUBY_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.RUBY_CRYSTAL_CLUSTER.getDefaultState()),
                        BlockTags.FEATURES_CANNOT_REPLACE , BlockTags.GEODE_INVALID_BLOCKS),
                        new GeodeLayerThicknessConfig(1.7, 2.2, 3.2, 4.2),
                        new GeodeCrackConfig(0.95, 2.0, 2),
                        0.35, 0.083,
        ...
        register(context, SAPPHIRE_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        BlockStateProvider.of(Blocks.CALCITE),
                        BlockStateProvider.of(Blocks.SMOOTH_BASALT),
                        List.of(MUBlocks.SAPPHIRE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.SAPPHIRE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.SAPPHIRE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.SAPPHIRE_CRYSTAL_CLUSTER.getDefaultState()),
                        BlockTags.FEATURES_CANNOT_REPLACE , BlockTags.GEODE_INVALID_BLOCKS),
                        new GeodeLayerThicknessConfig(1.7, 2.2, 3.2, 4.2),
                        new GeodeCrackConfig(0.95, 2.0, 2),
                        0.35, 0.083,
        ...
        register(context, TOPAZ_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        BlockStateProvider.of(Blocks.CALCITE),
                        BlockStateProvider.of(Blocks.SMOOTH_BASALT),
                        List.of(MUBlocks.TOPAZ_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.TOPAZ_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.TOPAZ_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.TOPAZ_CRYSTAL_CLUSTER.getDefaultState()),
                        BlockTags.FEATURES_CANNOT_REPLACE , BlockTags.GEODE_INVALID_BLOCKS),
                        new GeodeLayerThicknessConfig(1.7, 2.2, 3.2, 4.2),
                        new GeodeCrackConfig(0.95, 2.0, 2),
                        0.35, 0.083,
        ...
        register(context, AMETRINE_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        BlockStateProvider.of(Blocks.CALCITE),
                        BlockStateProvider.of(Blocks.SMOOTH_BASALT),
                        List.of(MUBlocks.AMETRINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.AMETRINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.AMETRINE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.AMETRINE_CRYSTAL_CLUSTER.getDefaultState()),
                        BlockTags.FEATURES_CANNOT_REPLACE , BlockTags.GEODE_INVALID_BLOCKS),
                        new GeodeLayerThicknessConfig(1.7, 2.2, 3.2, 4.2),
                        new GeodeCrackConfig(0.95, 2.0, 2),
                        0.35, 0.083,
        ...
        register(context, JADE_CRYSTAL_GEODE_KEY, Feature.GEODE ,
                new GeodeFeatureConfig(new GeodeLayerConfig(BlockStateProvider.of(Blocks.AIR),
                        ...
                        BlockStateProvider.of(Blocks.CALCITE),
                        BlockStateProvider.of(Blocks.SMOOTH_BASALT),
                        List.of(MUBlocks.JADE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.JADE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.JADE_CRYSTAL_CLUSTER.getDefaultState(), MUBlocks.JADE_CRYSTAL_CLUSTER.getDefaultState()),
                        BlockTags.FEATURES_CANNOT_REPLACE , BlockTags.GEODE_INVALID_BLOCKS),
                        new GeodeLayerThicknessConfig(1.7, 2.2, 3.2, 4.2),
                        new GeodeCrackConfig(0.95, 2.0, 2),
                        0.35, 0.083,
