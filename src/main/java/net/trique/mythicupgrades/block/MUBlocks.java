...
public class MUBlocks {
    ...
    public static final Block AMETRINE_ORE = registerBlock("ametrine_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(16, 32), AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).mapColor(MapColor.PALE_YELLOW).strength(3.0f, 1200.0f)));
    ...
    public static final Block NECOIUM_ORE = registerBlock("necoium_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(16, 32), AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).mapColor(MapColor.PALE_YELLOW).strength(3.0f, 1200.0f).instrument(Instrument.FLUTE)));
