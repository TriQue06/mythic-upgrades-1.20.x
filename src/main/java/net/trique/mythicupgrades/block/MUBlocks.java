...
public class MUBlocks {
    ...
    public static final Block DEEPSLATE_AQUAMARINE_ORE = registerBlock("deepslate_aquamarine_ore",
            new DropExperienceBlock(UniformInt.of(32, 64), BlockBehaviour.Properties.ofFullCopy(AQUAMARINE_ORE).mapColor(MapColor.DEEPSLATE).strength(4.5f, 1200.0f).sound(SoundType.DEEPSLATE)));
    ...
    private static Block registerBlock(String name, Block block) {
        ...
        return Registry.register(BuiltInRegistries.BLOCK, ResourceLocation.fromNamespaceAndPath(MythicUpgrades.MOD_ID, name), block);
    }

    private static void registerBlockItem(String name, Block block) {
        Registry.register(BuiltInRegistries.ITEM, ResourceLocation.fromNamespaceAndPath(MythicUpgrades.MOD_ID, name),
