...
public class MUBlocks {
    ...
    public static final Block KYANITE_ORE = registerBlock("kyanite_ore",
            new ExperienceDroppingBlock(UniformIntProvider.create(16, 32), AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).sounds(BlockSoundGroup.BASALT).strength(3.0f, 1200.0f)));
