...
public class MythicBlocks {
    ...
    public static final Block JADE_CRYSTAL_BLOCK = registerBlock("jade_crystal_block",
            new Block(AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).mapColor(MapColor.LIME).sounds(BlockSoundGroup.AMETHYST_BLOCK).requiresTool().luminance(value -> 10).strength(2.0f, 1200.0f)));

    public static final Block JADE_ORE = registerBlock("jade_ore",
            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).requiresTool().strength(3.0f, 1200.0f), UniformIntProvider.create(4, 8)));
    ...
    public static final Block DEEPSLATE_JADE_RUINS = registerBlock("deepslate_jade_ruins",
            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).mapColor(MapColor.DEEPSLATE_GRAY).strength(4.5f, 1200.0f).sounds(BlockSoundGroup.DEEPSLATE), UniformIntProvider.create(4, 8)));
    ...
    public static final Block TOPAZ_CRYSTAL_BLOCK = registerBlock("topaz_crystal_block",
            new Block(AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).mapColor(MapColor.TERRACOTTA_ORANGE).sounds(BlockSoundGroup.AMETHYST_BLOCK).requiresTool().luminance(value -> 10).strength(3.0f, 1200.0f)));
    ...
    public static final Block DEEPSLATE_TOPAZ_RUINS = registerBlock("deepslate_topaz_ruins",
            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(TOPAZ_ORE).mapColor(MapColor.DEEPSLATE_GRAY).strength(4.5f, 1200.0f).sounds(BlockSoundGroup.DEEPSLATE), UniformIntProvider.create(2, 8)));



    public static final Block AQUAMARINE_CRYSTAL_BLOCK = registerBlock("aquamarine_crystal_block",
            new Block(AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).mapColor(MapColor.LIGHT_BLUE).sounds(BlockSoundGroup.AMETHYST_BLOCK).requiresTool().luminance(value -> 10).strength(2.0f, 1200.0f)));
    ...
    public static final Block DEEPSLATE_AQUAMARINE_ORE = registerBlock("deepslate_aquamarine_ore",
            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(AQUAMARINE_ORE).mapColor(MapColor.DEEPSLATE_GRAY).strength(4.5f, 1200.0f).sounds(BlockSoundGroup.DEEPSLATE), UniformIntProvider.create(4, 8)));

    public static final Block AQUAMARINE_RUINS = registerBlock("aquamarine_ruins",
            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).requiresTool().strength(3.0f, 1200.0f), UniformIntProvider.create(4, 8)));

    public static final Block DEEPSLATE_AQUAMARINE_RUINS = registerBlock("deepslate_aquamarine_ruins",
            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(AQUAMARINE_ORE).mapColor(MapColor.DEEPSLATE_GRAY).strength(4.5f, 1200.0f).sounds(BlockSoundGroup.DEEPSLATE), UniformIntProvider.create(4, 8)));
    ...
    public static final Block SAPPHIRE_CRYSTAL_BLOCK = registerBlock("sapphire_crystal_block",
            new Block(AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).mapColor(MapColor.LAPIS_BLUE).sounds(BlockSoundGroup.AMETHYST_BLOCK).requiresTool().luminance(value -> 10).strength(2.0f, 1200.0f)));
    ...
    public static final Block RUBY_CRYSTAL_BLOCK = registerBlock("ruby_crystal_block",
            new Block(AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).mapColor(MapColor.DARK_RED).sounds(BlockSoundGroup.AMETHYST_BLOCK).requiresTool().luminance(value -> 10).strength(2.0f, 1200.0f)));
    ...
    public static final Block AMETRINE_CRYSTAL_BLOCK = registerBlock("ametrine_crystal_block",
            new Block(AbstractBlock.Settings.copy(Blocks.AMETHYST_BLOCK).mapColor(MapColor.PURPLE).sounds(BlockSoundGroup.AMETHYST_BLOCK).requiresTool().luminance(value -> 10).strength(2.0f, 1200.0f)));

    public static final Block AMETRINE_ORE = registerBlock("ametrine_ore",
            new ExperienceDroppingBlock(AbstractBlock.Settings.copy(Blocks.DIAMOND_ORE).mapColor(MapColor.PALE_YELLOW).requiresTool().strength(6.0f, 1200.0f), UniformIntProvider.create(4, 8)));
