...
extends AmethystBlock {
    ...
    public void afterBreak(World world, PlayerEntity player, BlockPos pos, BlockState state, @Nullable BlockEntity blockEntity, ItemStack tool) {
        ...
        if (MythicUpgrades.CONFIG.rubyConfig.silk_touch_budding_crystal() && EnchantmentHelper.hasSilkTouch(tool)) {
            dropStack(world, pos, MUBlocks.BUDDING_RUBY_CRYSTAL.asItem().getDefaultStack());
        }
    }
}